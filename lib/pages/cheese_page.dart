...
import 'package:pizza_app_s/pages/end_page.dart';
...
class CheeesePage extends StatefulWidget {
  const CheeesePage({
    Key? key,
    required this.pizza,
  }) : super(key: key);
  ...
  @override
  State<CheeesePage> createState() => _CheeesePageState();
}

class _CheeesePageState extends State<CheeesePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomFutureBuilder<List<PizzaItem>>(
      future: BlocProvider.of<StoreBloc>(context).getPizzaFromage(),
          ...
          onForward: selectedPizzaItems.isEmpty
              ...
              : () {
                  Navigator.push(
                    context,
                    PageRouteBuilder(
                      pageBuilder: (_, __, ___) => EndPage(
                        pizza: widget.pizza.copyWith(
                          pizzaFromages: selectedPizzaItems,
                        ),
                      ),
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      'Le/les fromages(s) sur votre pizza',
